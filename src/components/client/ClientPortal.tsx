...
import { ClientSpecialties } from './ClientSpecialties';
...
export const ClientPortal: React.FC<ClientPortalProps> = ({
  ...
  return (
    <div className="w-full bg-obsidian-deep overflow-hidden">
      ...
      {/* 2. Core Agency Capabilities & Specialties */}
      <ClientSpecialties onOpenBooking={() => onOpenBookingModal()} />

      {/* 3. Slow Travel Manifesto Ethos */}
      <ClientEthos />
          ...
          <div className="relative w-full max-w-4xl bg-[#090E13] border border-white/10 rounded-3xl p-6 sm:p-10 shadow-2xl space-y-6 my-8">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-6">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-sand-muted hover:text-ivory hover:bg-white/5 transition-all cursor-pointer"
